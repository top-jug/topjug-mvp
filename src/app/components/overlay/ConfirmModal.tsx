...
export default function ConfirmModal(props: ConfirmModalProps) {
  ...
  return (
    <CenteredModalShell onClose={handleClose} title={`${title} 확인`} description={description} role="alertdialog" dismissible={!isPending} panelClassName="max-w-[340px] bg-white rounded-3xl p-6">
