...
async function main() {
  ...
  try {
    ...
    const emailChallenges = await deleteBatch(client, 'email_verification_challenges', 'expires_at', '1 day');
    ...
    console.info(JSON.stringify({
      ...
      deleted: { attempts: attempts.count, emailChallenges: emailChallenges.count, sessions: sessions.count, audits: audits.count },
    }));
  } finally {
    await client.end();
  }
